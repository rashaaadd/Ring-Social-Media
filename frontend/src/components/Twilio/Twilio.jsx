...
function Twilio({data}) {
  ...
  return (
    <form onSubmit={handleSubmit} className="infoForm authForm">
        <h5>OTP sent</h5>
        <p style={{fontSize:'12px',alignSelf:'center',width:'80%'}}>We sent an OTP to +91-{userData?.phone.slice(0,3)}****{userData?.phone.slice(-3)}. Please verify yourself to change password.</p>
